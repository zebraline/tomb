...
It's perfectly fine to re-use this definition in the tomb application,
though.
...
__all__ = ['User', 'Message', 'Image']

from sqlalchemy import Table, ForeignKey, Column
from sqlalchemy.types import Unicode, Integer, DateTime, TIMESTAMP
from sqlalchemy.orm import relation, synonym

from tomb.model import DeclarativeBase, metadata, DBSession
...
class User(DeclarativeBase):
    ...
    user_id = Column(Integer, autoincrement=True, primary_key=True)
    user_name = Column(Unicode(16), unique=True, nullable=False)
    email_address = Column(Unicode(255), unique=False, nullable=True)
    display_name = Column(Unicode(255), nullable=True)
    photo = Column(Unicode(255), nullable=True)
    password = Column('password', Unicode(128))
